                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($item->is_homepage == 1)
                                                        <a href="{{route('admin.category.is_homepage_status',[$item->id,0])}}" class="badge badge-success">Yes</a>
                                                    @elseif($item->is_homepage == 0)
                                                        <a href="{{route('admin.category.is_homepage_status',[$item->id,1])}}" class="badge badge-danger">No</a>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if($item->status ==1)
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" class="mr-1 edit_cat_btn" data-toggle="modal" data-target="#edit_cat"
                                                       data-id="{{$item->id}}" data-name="{{$item->category_name}}" data-status="{{$item->status}}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="{{route('admin.category.delete',$item->id)}}" onclick="return confirm('Are you sure to delete this?')"><i
