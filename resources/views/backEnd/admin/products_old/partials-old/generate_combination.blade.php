        ...
        @foreach ($combinations as $key => $combination)
            ...
            @if(strlen($str) > 0)
                <tr class="variant">
                    ...
                    <td>
                        <input type="number" name="variant_price[]" value="{{$unit_price??0}}" min="0" step="0.01" class="form-control auto-select-number"
                               required>
                    </td>
                    {{--<td>
                    ...
                    <td>
                        <input type="number" lang="en" name="variant_stock[]" value="10" min="0" step="1" class="form-control auto-select-number" required>
                    </td>
                    <td>
