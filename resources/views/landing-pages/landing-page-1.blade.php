...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('landing-page/landing-page-1/assets/css/style.css') }}">
    @if (isset($enableEdit))
...
<body>
    ...
    @php
        ...
        $images = $content['images'] ?? [
            1 => 'landing-page/landing-page-1/images/logo.webp',
            2 => 'landing-page/landing-page-1/images/sddefault-1.jpg',
            3 => 'landing-page/landing-page-1/images/img11.png',
            4 => 'landing-page/landing-page-1/images/img14.png',
            5 => 'landing-page/landing-page-1/images/img15.png',
            6 => 'landing-page/landing-page-1/images/6.jpg',
            7 => 'landing-page/landing-page-1/images/7.jpg',
            8 => 'landing-page/landing-page-1/images/8.jpg',
    ...
    <section
        ...
        style="background-image: url('{{ asset('landing-page/landing-page-1/images/bg.e6bad191.png') }}');">
        ...
        <div class="custom-container  {{ $section_status['section_1'] ?? '' }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="banner-text lp_text_editable get_main_text_0"
                        style="{{ $style['get_style_0'] ?? '' }}">
                        {{ $main_text[0] ?? 'ফ্লোরাল প্রিন্টেড' }}
                    </div>
                    <div class="banner-title lp_text_editable get_main_text_1"
                        style="{{ $style['get_style_1'] ?? '' }}">
                        {{ $main_text[1] ?? 'ইন্ডিয়ান রাজস্থানী সুতি বুটিক রাজপরী থ্রি পিস' }}
                        {{-- @dd($main_text) --}}
                    </div>
                    <div class="banner-price">
                        <span class="offer-price lp_text_editable get_main_text_2"
                            style="{{ $style['get_style_2'] ?? '' }}">
                            {{ $main_text[2] ?? '৳ ৮০০ টাকা' }}
                        </span>
                        <span class="old-price lp_text_editable get_main_text_3"
                            style="{{ $style['get_style_3'] ?? '' }}">
                            {{ $main_text[3] ?? '৳ ১,১০০' }}
                        </span>
                    </div>
                    ...
                    <div class="contact">
                        <div class="bg-text">
                            <span class="text lp_text_editable get_main_text_4"
                                style="{{ $style['get_style_4'] ?? '' }}">
                                {{ $main_text[4] ?? 'অর্ডার করতে কল করুন' }} </span>
                            <span class="number lp_text_editable get_main_text_5"
                                style="{{ $style['get_style_5'] ?? '' }}">
                                {{ $main_text[5] ?? '01894844452' }}</span>
                        </div>
                        <div class="text lp_text_editable get_main_text_6" style="{{ $style['get_style_6'] ?? '' }}">
                            {{ $main_text[6] ?? 'সাথে পাচ্ছেন সারা দেশে ক্যাশ অন ডেলিভারি' }}
                        </div>
                ...
                <div class="col-md-6">
                    {{-- @dd($images) --}}
                    <div class="image lp_image_editable" data-image_id="2">
                        <img src="{{ asset($images[2] ?? 'landing-page/landing-page-1/images/img.png') }}"
                            alt="">
                    </div>


                    {{-- <img class="small-img" src="{{ asset('landing-page/landing-page-1/images') }}/img3.png"
                            alt=""> --}}
                </div>
    ...
    <section
        class="banner-shipping {{ empty($enableEdit) && data_get($section_status, 'section_2') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="custom-container  {{ $section_status['section_2'] ?? '' }}">
            <div class="shipping-text lp_text_editable get_main_text_7" style="{{ $style['get_style_7'] ?? '' }}">
                {{ $main_text[7] ?? 'আপনি কি আপনার পছন্দের বুটিক থ্রি পিস ডিজাইন খুঁজছেন? অথবা সেরা কিছু বুটিক ড্রেস খুঁজছেন তাহলে আমাদের ড্রেস গুলা দেখুন' }}
            </div>
        </div>
    </section>

    <section
        class="shipping-address {{ empty($enableEdit) && data_get($section_status, 'section_3') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="custom-container  {{ $section_status['section_3'] ?? '' }}">
            <div class="row">
                <div class="col-md-3 item">
                    <div class="image">
                        <img src="{{ asset('landing-page/landing-page-1/images') }}/img5.webp" alt="">
                    </div>
                    <div class="text lp_text_editable get_main_text_8" style="{{ $style['get_style_8'] ?? '' }}">
                        {{ $main_text[8] ?? 'Free 2 Days Shipping' }}
                ...
                <div class="col-md-3 item">
                    ...
                    <div class="text lp_text_editable get_main_text_9" style="{{ $style['get_style_9'] ?? '' }}">
                        {{ $main_text[9] ?? 'Free 2 Days Shipping' }}
                    </div>
                </div>
                <div class="col-md-3 item">
                    <div class="image">
                    ...
                    <div class="text lp_text_editable get_main_text_10" style="{{ $style['get_style_10'] ?? '' }}">
                        {{ $main_text[10] ?? 'Free 2 Days Shipping' }}
                    </div>
                </div>
                <div class="col-md-3 item">
                    <div class="image">
                    ...
                    <div class="text lp_text_editable get_main_text_11" style="{{ $style['get_style_11'] ?? '' }}">
                        {{ $main_text[11] ?? 'Free 2 Days Shipping' }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <section
        class="model {{ empty($enableEdit) && data_get($section_status, 'section_4') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="custom-container  {{ $section_status['section_4'] ?? '' }}">
            <div class="row">
                <div class="col-md-6 col-sm-12 item">
                    <div class="image">
                        {{-- <img class="back-img" src="{{ asset('landing-page/landing-page-1/images') }}/img10.png"
                            alt=""> --}}
                        <div class="img1 lp_image_editable" data-image_id="3">
                            <img src="{{ asset($images[3] ?? 'landing-page/landing-page-1/images/img11.png') }}"
                                alt="">
                        </div>
                ...
                <div class="col-md-6 col-sm-12 item">
                    <div class="text">
                        <div class="title lp_text_editable get_main_text_12"
                            style="{{ $style['get_style_12'] ?? '' }}">
                            {{ $main_text[12] ?? 'মেরুন প্রিন্টেড এবং এমব্রয়ডারি করা হ্যান্ডলুম ভিসকস-কটন কামিজ' }}

                        </div>
                        <div class="description lp_text_editable get_main_text_13"
                            style="{{ $style['get_style_13'] ?? '' }}">
                            {{ $main_text[13] ??
                                'ইন্ডিয়ান রাজস্থানী বুটিক 3 পিস – ইন্ডিয়ান কালেকশন আরামদায়ক ও মানসম্পন্ন কাপড় দিয়ে তৈরি
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                এবং
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                সম্পূর্ণ পিওর কটনে ইন্ডিয়ান কারচুপি ওয়ার্ক করা বুটিক 3 পিস কাপড়ের গুনগতমান খুবই ভালো এবং
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                সন্দর, এই গরমে থ্রি পিসটি ব্যবহারে অনেক আরামদায়ক হবে রিজনেবল প্রাইজে এই ফুল কটন সুন্দর
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                থ্রি
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                পিসটি পেয়ে যাচ্ছেন fashion.com থেকে।' }}
                            ...
                            <ul>
                                @if (count($subtext_one) > 0)
                                    @foreach ($subtext_one as $key => $sub_text_one)
                                        <li><img src="{{ asset('landing-page/landing-page-1/images') }}/img23.png"
                                                alt="">
    ...
    <section
        class="youtube-video {{ empty($enableEdit) && data_get($section_status, 'section_5') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="custom-container  {{ $section_status['section_5'] ?? '' }}">
            <div class="video lp_video_editable" data-video_id="1">
                <iframe src="{{ $videos[1] ?? 'https://www.youtube.com/embed/4w2PmVFegC8' }}" frameborder="0"
                    ...
                    width="100%" height="100%" id="widget2"></iframe>
    ...
    <seciton
        class="order {{ empty($enableEdit) && data_get($section_status, 'section_6') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <img src="{{ asset('landing-page/landing-page-1/images') }}/img12.png" alt="">
        <div class="custom-container  {{ $section_status['section_6'] ?? '' }}">
            <div class="title lp_text_editable get_main_text_14" style="{{ $style['get_style_14'] ?? '' }}">
                {{ $main_text[14] ?? ' আমাদের এই ইন্ডিয়ান রাজস্থানী বুটিক 3 পিস কেন নিবেন !' }}

            </div>
            <div class="description lp_text_editable get_main_text_15" style="{{ $style['get_style_15'] ?? '' }}">
                {{ $main_text[15] ??
                    'ইন্ডিয়ান রাজস্থানী বুটিক 3 পিস – ইন্ডিয়ান কালেকশন আরামদায়ক ও মানসম্পন্ন কাপড় দিয়ে তৈরি এবং সম্পূর্ণ
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                পিওর কটনে ইন্ডিয়ান কারচুপি ওয়ার্ক করা বুটিক 3 পিস কাপড়ের গুনগতমান খুবই ভালো এবং সন্দর, এই গরমে থ্রি
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                পিসটি ব্যবহারে অনেক আরামদায়ক হবে রিজনেবল প্রাইজে এই ফুল কটন সুন্দর থ্রি পিসটি পেয়ে যাচ্ছেন
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                fashion.com থেকে। আমাদের এই ইন্ডিয়ান রাজস্থানী বুটিক 3 পিস কেন নিবেন !' }}

            </div>

            <div class="order-content">
                <img class="order-img" src="{{ asset('landing-page/landing-page-1/images') }}/img13.png"
                    alt="">
                <div class="text-content">
                    <div class="delivery-text lp_text_editable get_main_text_16"
                        style="{{ $style['get_style_16'] ?? '' }}">
                        {{ $main_text[16] ?? ' সারা দেশে ফ্রি হোম ডেলিভারি' }}

                    </div>
                    <div class="package-text lp_text_editable get_main_text_17"
                        style="{{ $style['get_style_17'] ?? '' }}">
                        {{ $main_text[17] ?? 'প্যাকেজ মূল্যঃ ৮০০ টাকা ' }}

                    </div>
                    <div class="button">
                        <a class="bg"> <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                viewBox="0 0 1024 1024" height="1em" width="1em"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d=" M922.9 701.9H327.4l29.9-60.9 496.8-.9c16.8 0 31.2-12
                    34.2-28.6l68.8-385.1c1.8-10.1-.9-20.5-7.5-28.4a34.99 34.99 0 0
                    0-26.6-12.5l-632-2.1-5.4-25.4c-3.4-16.2-18-28-34.6-28H96.5a35.3 35.3 0 1 0 0 70.6h125.9L246
                    312.8l58.1 281.3-74.8 122.1a34.96 34.96 0 0 0-3 36.8c6 11.9 18.1 19.4 31.5 19.4h62.8a102.43 102.43 0
                    0 0-20.6 61.7c0 56.6 46 102.6 102.6 102.6s102.6-46 102.6-102.6c0-22.3-7.4-44-20.6-61.7h161.1a102.43
                    102.43 0 0 0-20.6 61.7c0 56.6 46 102.6 102.6 102.6s102.6-46
                    102.6-102.6c0-22.3-7.4-44-20.6-61.7H923c19.4 0 35.3-15.8 35.3-35.3a35.42 35.42 0 0
                    0-35.4-35.2zM305.7 253l575.8 1.9-56.4 315.8-452.3.8L305.7 253zm96.9 612.7c-17.4
                    0-31.6-14.2-31.6-31.6 0-17.4 14.2-31.6 31.6-31.6s31.6 14.2 31.6 31.6a31.6 31.6 0 0 1-31.6
                    31.6zm325.1 0c-17.4 0-31.6-14.2-31.6-31.6 0-17.4 14.2-31.6 31.6-31.6s31.6 14.2 31.6 31.6a31.6 31.6 0
                    0 1-31.6 31.6z">
                                </path>
                            </svg>অর্ডার করতে এখানে ক্লিক করুন</a>
                    </div>

                </div>
                <div class="bottom-img lp_image_editable" data-image_id="4">
                    <img src="{{ asset($images[4] ?? 'landing-page/landing-page-1/images/img14.png') }}"
                        alt="">
                </div>
            </div>
    ...
    <section
        class="order-box {{ empty($enableEdit) && data_get($section_status, 'section_7') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="custom-container  {{ $section_status['section_7'] ?? '' }}">
            {{-- <img src="{{ asset('landing-page/landing-page-1/images') }}/img15.png" alt=""> --}}
            <div class="image lp_image_editable" data-image_id="5">
                <img src="{{ asset($images[5] ?? 'landing-page/landing-page-1/images/img15.png') }}" alt="">
            </div>
            <div class="row">
                <div class="col-md-6 item">
                    <ul>
                        @if (count($subtext_two) > 0)
                            @foreach ($subtext_two as $key => $sub_text_two_one)
                                <li>
                                    <img src="{{ asset('landing-page/landing-page-1/images') }}/img23.png"
                                        alt="">
                ...
                <div class="col-md-6 item">
                    <ul>
                        @if (count($subtext_three) > 0)
                            @foreach ($subtext_three as $key => $sub_text_two_two)
                                <li><img src="{{ asset('landing-page/landing-page-1/images') }}/img23.png"
                                        alt="">
    ...
    {{-- <section class="customer-review">
        <div class="custom-container">
            <div class="row">
                ...
                <div class="col-md-6 item">
                    <img src="{{ asset('landing-page/landing-page-1/images') }}/customer-review1.png" alt="">
                </div>
                <div class="col-md-6 item">
                    <img src="{{ asset('landing-page/landing-page-1/images') }}/customer-review1.png" alt="">
                </div>
    ...
    <section
        class="order2 {{ empty($enableEdit) && data_get($section_status, 'section_8') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="custom-container  {{ $section_status['section_8'] ?? '' }}">
            <div class="image">
                <img src="{{ asset('landing-page/landing-page-1/images') }}/img17.png" alt="">
                <div class="text-content">
                    <div class="delivery-text lp_text_editable get_main_text_18"
                        style="{{ $style['get_style_18'] ?? '' }}">
                        {{ $main_text[18] ?? '১৯৯৯ টাকার অর্ডার করতে সাথে পাচ্ছেন হোম ডেলিভারি' }}

                    </div>
                    <div class="package-text lp_text_editable get_main_text_19"
                        style="{{ $style['get_style_19'] ?? '' }}">
                        {{ $main_text[19] ?? 'প্যাকেজ মূল্যঃ ৮০০ টাকা ' }}
            ...
            <div class="text text-center">
                <h2 class="lp_text_editable get_main_text_20" style="{{ $style['get_style_20'] ?? '' }}">
                    {{ $main_text[20] ?? 'আমাদের রিফান্ড পলিসি গুলা' }} </h2>
                <p class="lp_text_editable get_main_text_21" style="{{ $style['get_style_21'] ?? '' }}">
                    {{ $main_text[21] ??
                        'আমাদের সাথে যোগাযোগ এর পরে প্রদান কৃত নির্দেশনা মোতাবেক প্রোডাক্ট টি ডেলিভারি ম্যান এর কাছে
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                হস্তান্তর করে দিতে হবে' }}
                </p>

                <p class="lp_text_editable get_main_text_22" style="{{ $style['get_style_22'] ?? '' }}">
                    {{ $main_text[22] ??
                        'এক্সচেঞ্জের সময় ডেলিভারি ম্যানের কাছে নিচের জিনিস গুলো অবশ্যই সঠিক ভাবে বুঝিয়ে দিতে হবে-' }}
                </p>
                <p class="lp_text_editable get_main_text_23" style="{{ $style['get_style_23'] ?? '' }}">
                    {{ $main_text[23] ??
                        'প্রোডাক্ট এ কোনো ত্রুটি থাকলে আমাদের এই নম্বর এ ( 01894844452 ) সাথে সাথে কল করে জানাতে হবে।' }}
                </p>
                <p class="lp_text_editable get_main_text_24" style="{{ $style['get_style_24'] ?? '' }}">
                    {{ $main_text[24] ?? 'প্রোডাক্ট টি গ্রহণের পর ভালো ভাবে চেক করে নিতে হবে ।' }}
                </p>
            </div>
        </div>
    </section>
