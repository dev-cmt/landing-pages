...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('landing-page/landing-page-7/assets/css/custom.css') }}">
    @if (isset($enableEdit))
...
<body>
    ...
    @php
        ...
        // $images = $content['images'] ?? [
        //     1 => 'landing-page/landing-page-7/assets/images/bg.png',
        //     2 => 'landing-page/landing-page-7/assets/images/p1.webp',
        //     3 => 'landing-page/landing-page-7/assets/images/p2.webp',
        //     4 => 'landing-page/landing-page-7/assets/images/p3.webp',
        //     5 => 'landing-page/landing-page-7/assets/images/p4.webp',
        //     6 => 'landing-page/landing-page-7/assets/images/p5.webp',
        //     7 => 'landing-page/landing-page-7/assets/images/p6.webp',
        //     8 => 'landing-page/landing-page-7/assets/images/p1.webp',
        //     9 => 'landing-page/landing-page-7/assets/images/p2.webp',
        //     10 => 'landing-page/landing-page-7/assets/images/p3.webp',
        //     11 => 'landing-page/landing-page-7/assets/images/p4.webp',
        //     12 => 'landing-page/landing-page-7/assets/images/p5.webp',
        //     13 => 'landing-page/landing-page-7/assets/images/p6.webp',
        // ];
    ...
    <!-- banner section -->
    <section
        class="banner-section {{ empty($enableEdit) && data_get($section_status, 'section_1') !== 'section_on' ? 'd-none' : '' }}">
        ...
        <div class="banner-animation-left-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img2.png" alt="">
        </div>
        <div class="banner-animation-right-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img2.png" alt="">
        </div>
        <div class="container {{ $section_status['section_1'] ?? '' }}">
            <div class="banner-content">
                <div class="logo lp_image_editable" data-image_id="1">
                    <img src="{{ asset($images[1] ?? 'landing-page/landing-page-7/assets/images/logo.png') }}"
                        alt="">
                </div>
                <div class="banner-title lp_text_editable get_main_text_0" style="{{ $style['get_style_0'] ?? '' }}">
                    {{ $main_text[0] ?? 'মদিনার রসালো স্বাদ ও পুষ্টিতে ভরপুর ন্যাচারালস সুপার প্রিমিয়াম খেজুর।' }}
                </div>
                <div class="banner-text">
                    <div class="call-text lp_text_editable get_main_text_1" style="{{ $style['get_style_1'] ?? '' }}">
                        {{ $main_text[1] ?? 'সরাসরি কিনতে ফোন করুন' }}
                    </div>
                    <div class="contact-info">
                        <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img32.png" alt="">
                        <span class="lp_text_editable get_main_text_2" style="{{ $style['get_style_2'] ?? '' }}">
                            {{ $main_text[2] ?? '0123456789' }}

                        </span>
                    </div>
                    <div class="offer-image">
                        <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img1.png" alt="">
                    </div>
                </div>
                <div class="banner-main-image  lp_image_editable" data-image_id="2">
                    <img src="{{ asset($images[2] ?? 'landing-page/landing-page-7/assets/images/img.png') }}"
                        alt="">
                </div>
            </div>
        </div>
    ...
    <!-- gift section -->
    <section
        class="gift-section {{ empty($enableEdit) && data_get($section_status, 'section_2') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="gift-background-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/bg2.png" alt="">
        </div>
        <div class="container {{ $section_status['section_2'] ?? '' }}">
            <div class="gift-box-title lp_text_editable get_main_text_27" style="{{ $style['get_style_27'] ?? '' }}">
                {{ $main_text[27] ?? 'কি কি থাকছে আমাদের এই Corporate Gift Box এ!' }}

            </div>
            <div class="row">
                <div class="col-md-4 col-12 mb-3">
                    <div class="gift-item">
                        <div class="gift-item-image lp_image_editable" data-image_id="3">
                            <img src="{{ asset($images[3] ?? 'landing-page/landing-page-7/assets/images/img3.png') }}"
                                alt="">
                        </div>
                        <h4 class="lp_text_editable get_main_text_3" style="{{ $style['get_style_3'] ?? '' }}">
                            {{ $main_text[3] ?? 'মরিয়ম খেজুর' }}
                ...
                <div class="col-md-4 col-12 mb-3">
                    <div class="gift-item">
                        <div class="gift-item-image lp_image_editable" data-image_id="4">
                            <img src="{{ asset($images[4] ?? 'landing-page/landing-page-7/assets/images/img4.png') }}"
                                alt="">
                        </div>
                        <h4 class="lp_text_editable get_main_text_4" style="{{ $style['get_style_4'] ?? '' }}">
                            {{ $main_text[4] ?? 'আজওয়া খেজুর' }}
                        </h4>
                    </div>
                </div>
                <div class="col-md-4 col-12 mb-3">
                    <div class="gift-item">
                        <div class="gift-item-image lp_image_editable" data-image_id="5">
                            <img src="{{ asset($images[5] ?? 'landing-page/landing-page-7/assets/images/img4.png') }}"
                                alt="">
                        </div>
                        <h4 class="lp_text_editable get_main_text_5" style="{{ $style['get_style_5'] ?? '' }}">
                            {{ $main_text[5] ?? 'আজওয়া খেজুর' }}
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <!-- price section one -->
    <section
        class="price-section {{ empty($enableEdit) && data_get($section_status, 'section_3') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="price-animation-left-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img6.png" alt="">
        </div>
        <div class="price-animation-right-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img7.png" alt="">
        </div>
        <div class="container {{ $section_status['section_3'] ?? '' }}">
            <div class="price-content">
                <div class="price-title">
                    <h4 class="lp_text_editable get_main_text_6" style="{{ $style['get_style_6'] ?? '' }}">
                        {{ $main_text[6] ?? 'মুল্য-৬০০ টাকা' }}
                    </h4>
                </div>
                <div class="price-subtitle lp_text_editable get_main_text_7"
                    style="{{ $style['get_style_7'] ?? '' }}">
                    {{ $main_text[7] ?? ' বক্সটির ওজন ১ কেজি' }}
                </div>
                ...
                <div class="price-description lp_text_editable get_main_text_8"
                    style="{{ $style['get_style_8'] ?? '' }}">
                    {{ $main_text[8] ??
                        'মদিনার আরেক খেজুরের নাম সাফাওয়ি। দেখতে প্রায় মরিয়ম খেজুরের মত। গাঢ় বাদামি রঙের লম্বাটে। খেতে
                                                                                                                                                                                                                                                                                                                                                                                                                মোটামুটি মিষ্টি। সাফওয়ি খেজুর মদিনা অঞ্চলের যেকোনো অন্য অঞ্চলের খেজুরের চেয়ে বেশি ফজিলতপূর্ণ' }}
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- video section -->
    <section
        class="video-section {{ empty($enableEdit) && data_get($section_status, 'section_4') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="container {{ $section_status['section_4'] ?? '' }}">
            <div class="video lp_video_editable" data-video_id="1">
                <iframe src="{{ str_replace('watch?v=', 'embed/', $videos[1]) }}" frameborder="0" allowfullscreen=""
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" title="" width="100%" height="100%"
                    id="widget2"></iframe>
            </div>
        </div>
    </section>
    ...
    <!-- why us section -->
    <section
        class="why-us-section {{ empty($enableEdit) && data_get($section_status, 'section_5') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="why-us-left-animation-image">
            <img src="{{ asset('landing-page/landing-page-7/assets/images/img8.png') }}" alt="">
        </div>
        <div class="why-us-right-animation-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img9.png" alt="">
        </div>
        <div class="container {{ $section_status['section_5'] ?? '' }}">
            <div class="why-us-content">
                <div class="why-us-title lp_text_editable get_main_text_9" style="{{ $style['get_style_9'] ?? '' }}">
                    {{ $main_text[9] ?? 'আমাদের এই মরিয়ম, সাফওয়ি, আজওয়া খেজুর বক্সগুলো কেন উপহার দিবেন' }}
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="why-us-card">
                            <div class="image lp_image_editable" data-image_id="6">
                                <img src="{{ asset($images[6] ?? 'landing-page/landing-page-7/assets/images/img11.png') }}"
                                    alt="">
                            </div>
                            <div class="title">
                                <h4 class="lp_text_editable get_main_text_28"
                                    style="{{ $style['get_style_28'] ?? '' }}">
                                    {{ $main_text[28] ?? 'সম্পর্ক স্থাপন' }}
                                </h4>
                            </div>
                            <div class="text">
                                <p class="lp_text_editable get_main_text_11"
                                    style="{{ $style['get_style_11'] ?? '' }}">
                                    {{ $main_text[10] ??
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="why-us-card">
                            <div class="image lp_image_editable" data-image_id="7">
                                <img src="{{ asset($images[7] ?? 'landing-page/landing-page-7/assets/images/img11.png') }}"
                                    alt="">
                            </div>
                            <div class="title">
                                <h4 class="lp_text_editable get_main_text_12"
                                    style="{{ $style['get_style_12'] ?? '' }}">
                                    {{ $main_text[12] ?? 'সম্পর্ক স্থাপন' }}
                                </h4>
                            </div>
                            <div class="text">
                                <p class="lp_text_editable get_main_text_13"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="why-us-card">
                            <div class="image lp_image_editable" data-image_id="8">
                                <img src="{{ asset($images[8] ?? 'landing-page/landing-page-7/assets/images/img11.png') }}"
                                    alt="">
                            </div>
                            <div class="title">
                                <h4 class="lp_text_editable get_main_text_14"
                                    style="{{ $style['get_style_14'] ?? '' }}">
                                    {{ $main_text[14] ?? 'সম্পর্ক স্থাপন' }}
                                </h4>
                            </div>
                            <div class="text">
                                <p class="lp_text_editable get_main_text_15"
                                    style="{{ $style['get_style_15'] ?? '' }}">
                                    {{ $main_text[15] ??
                                        'আমাদের দেশে এখন আরবের বিভিন্ন নামি দামি খেজুর পাওয়া যায়। আগে আমরা ছোটবেলায় শুধু এক
                                                                                                                                                                                                                                                                                                                                                                                                                                                ধরনের খেজুর ই দেখতাম তাও রমজান মাস ছাড়া অন্য মাসে দেখাও যেত না তেমন।' }}
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="why-us-card">
                            <div class="image lp_image_editable" data-image_id="9">
                                <img src="{{ asset($images[9] ?? 'landing-page/landing-page-7/assets/images/img11.png') }}"
                                    alt="">
                            </div>
                            <div class="title">
                                <h4 class="lp_text_editable get_main_text_16"
                                    style="{{ $style['get_style_16'] ?? '' }}">
                                    {{ $main_text[16] ?? 'সম্পর্ক স্থাপন' }}
                                </h4>
                            </div>
                            <div class="text">
                                <p class="lp_text_editable get_main_text_17"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="why-us-card">
                            <div class="image lp_image_editable" data-image_id="10">
                                <img src="{{ asset($images[10] ?? 'landing-page/landing-page-7/assets/images/img11.png') }}"
                                    alt="">
                            </div>
                            <div class="title">
                                <h4 class="lp_text_editable get_main_text_18"
                                    style="{{ $style['get_style_18'] ?? '' }}">
                                    {{ $main_text[18] ?? 'সম্পর্ক স্থাপন' }}
                                </h4>
                            </div>
                            <div class="text">
                                <p class="lp_text_editable get_main_text_19"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="why-us-card">
                            <div class="image lp_image_editable" data-image_id="11">
                                <img src="{{ asset($images[11] ?? 'landing-page/landing-page-7/assets/images/img11.png') }}"
                                    alt="">
                            </div>
                            <div class="title">
                                <h4 class="lp_text_editable get_main_text_20"
                                    style="{{ $style['get_style_20'] ?? '' }}">
                                    {{ $main_text[20] ?? 'সম্পর্ক স্থাপন' }}
                                </h4>
                            </div>
                            <div class="text">
                                <p class="lp_text_editable get_main_text_21"
                                    style="{{ $style['get_style_21'] ?? '' }}">
                                    {{ $main_text[21] ??
                                        'আমাদের দেশে এখন আরবের বিভিন্ন নামি দামি খেজুর পাওয়া যায়। আগে আমরা ছোটবেলায় শুধু এক
                                                                                                                                                                                                                                                                                                                                                                                                                                                ধরনের খেজুর ই দেখতাম তাও রমজান মাস ছাড়া অন্য মাসে দেখাও যেত না তেমন।' }}
    ...
    <section
        class="price-section-two {{ empty($enableEdit) && data_get($section_status, 'section_6') !== 'section_on' ? 'd-none' : '' }}">
        <div class="section-off-on-buttons">
        ...
        <div class="price-section-two-left-animation-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img26.png" alt="">
        </div>
        <div class="price-section-two-right-animation-image">
            <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img25.png" alt="">
        </div>
        <div class="container {{ $section_status['section_6'] ?? '' }}">
            <div class="price-two-image">
                <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img24.png" alt="">
                <div class="price-content-two">
                    <div class="call-title lp_text_editable get_main_text_22"
                        style="{{ $style['get_style_22'] ?? '' }}">
                        {{ $main_text[22] ?? 'সরাসরি কিনতে ফোন করুন' }}

                    </div>
                    <div class="contact-info contact-info-two">
                        <img src="{{ asset('landing-page/landing-page-7') }}/assets/images/img32.png" alt="">
                        <span class="lp_text_editable get_main_text_23" style="{{ $style['get_style_23'] ?? '' }}">
                            {{ $main_text[23] ?? '০১১২৩৪৫৬৭৮৯' }}
                        </span>
                    </div>
                    <div class="weight-text">
                        <h5 class="lp_text_editable get_main_text_24" style="{{ $style['get_style_24'] ?? '' }}">
                            {{ $main_text[24] ?? 'খেজুরের ওজন ১ কেজি ' }}
                        </h5>
                    </div>
                    <div class="price-text">
                        <h4 class="lp_text_editable get_main_text_25" style="{{ $style['get_style_25'] ?? '' }}">
                            {{ $main_text[25] ?? 'মুল্য-৬০০ টাকা ' }}
                        </h4>
                    </div>
                    <a class="order-now-button">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
    ...
    <section
        ...
        <div class="section-off-on-buttons">
            <input type="checkbox" name="section_seven" class="section_switch" hidden="hidden" data-section="7"
                id="section_seven_switch"
                {{ ($section_status['section_7'] ?? '') == 'section_on' ? 'checked' : '' }}>
        ...
        <div class="container">
            <div class="order-content">
                <div class="order-heading">
                    <h2 class="lp_text_editable get_main_text_26" style="{{ $style['get_style_26'] ?? '' }}">
                        {{ $main_text[26] ?? 'অর্ডার করতে সঠিক তথ্য দিয়ে নিচের ফর্ম পূরন করুন' }}
                    </h2>
                </div>
